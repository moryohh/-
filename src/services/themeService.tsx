...
export const APP_THEMES: Record<AppThemeId, ThemeConfig> = {
  ...
  // 3. Amber Work (Light Warm Amber & Focus Yellow)
  amber_work: {
    id: 'amber_work',
    name: 'نمط العمل والتركيز الكهرماني',
    subtitle: 'أصفر نشط وعنبري دافئ بخلفية فاتحة مشجعة للنشاط والتركيز',
    isLight: true,
    colors: {
      primary: '#CA8A04',
      secondary: '#EAB308',
    ...
    classes: {
      outerBg: 'bg-[#FEF9C3]',
      wrapperBg: 'bg-gradient-to-b from-[#FFFFF0] via-[#FEFCE8] to-[#FEF9C3]',
      headerBg: 'bg-[#FFFFF0]/95',
      navBg: 'bg-[#FFFFF0]/95',
      cardBg: 'bg-white shadow-md',
      cardSubtleBg: 'bg-[#FEFCE8]',
      cardBorder: 'border-yellow-200 shadow-sm',
      textMain: 'text-yellow-950',
      textMuted: 'text-yellow-800/80',
      accentText: 'text-yellow-600',
      accentBg: 'bg-gradient-to-r from-yellow-500 to-amber-600 text-white',
      accentBorder: 'border-yellow-400/60',
      modalBg: 'bg-white text-yellow-950',
      glowBlob1: 'bg-yellow-400/15',
      glowBlob2: 'bg-amber-400/15',
