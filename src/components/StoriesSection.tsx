    ...
    >
      ...
      <div className="flex items-center gap-2 overflow-x-auto no-scrollbar py-1">
        ...
        >
          ...
          >
            <div className={`w-full h-full rounded-full ${theme.classes.cardSubtleBg} flex items-center justify-center overflow-hidden relative`}>
              <DailyExamAuthenticIcon className="w-14 h-14 group-hover:scale-110 transition-transform" />
            </div>
          </div>
          <span className="text-[11px] mt-1 font-black text-center truncate max-w-[80px]" style={{ color: theme.colors.secondary }}>اختبر نفسك</span>
          <span className={`text-[9px] ${theme.classes.textMuted} max-w-[80px] truncate font-semibold`}>ألعاب تعليمية</span>
        </button>
